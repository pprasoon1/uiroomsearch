...
const Home = () => {
  return (
    <div className='relative h-screen w-screen'>
      ...
      <div className='absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center text-white text-4xl md:text-8xl font-extrabold pt-4'>
      ...
      <div className='absolute bottom-8 left-1/2 transform -translate-x-1/2 text-center'>
        <Link to={'/proceed'}>
          <button className='bg-zinc-900 text-white py-2 px-12 rounded-3xl text-2xl'>
