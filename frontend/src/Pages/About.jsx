        ...
        <div className="bg-white bg-opacity-35 p-6 rounded-lg shadow-lg font-mono">
          ...
          <div className="text-center">
            <div className="mb-6">
              ...
              <p className="text-xl text-zinc-900">LinkedIn: <a href="https://www.linkedin.com/in/pprasoon01/" className="text-red-900 underline" target="_blank" rel="noopener noreferrer">click here</a></p>
            </div>
            <div className="mb-6">
              <p className="text-2xl font-bold text-gray-900">Aryan Patel</p>
              <p className="text-xl text-zinc-900">Phone: 8817839559</p>
              <p className="text-xl text-zinc-900">LinkedIn: <a href="https://www.linkedin.com/in/-aryan-patel/" className="text-red-900 underline" target="_blank" rel="noopener noreferrer">click here</a></p>
            </div> 
